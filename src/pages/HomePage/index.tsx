      ...
      <div className='profile-head'>
        ...
        <div className='profile-icons'>
         <Link to='/' className='notify'>
          <span className="cursor-pointer">{icons.blackuserIcon()}</span></Link>
          <Link to='/' className='notify'><span>{icons.bellIcon()}</span></Link>
        </div>
      </div>
      </HomeInfoWrapper>
      {/* Card Hero */}
    <HeroWrapper>
      ...
      <NotifyWrapper>
        <div className='notify-1'>
          <p>Upgrade to KYC with higher <br /> transaction limit.</p>
        </div>
